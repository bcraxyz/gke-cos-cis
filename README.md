...
The scanner loads 117 benchmarks at Level 2 but evaluates ~112. The 5 skipped checks are IPv6 firewall rules (CIS 3.3.1.x) that `cis-level2.service` opts out of on GKE because GKE manages its own network policy layer. This is expected and correct — 0 checks fail.
